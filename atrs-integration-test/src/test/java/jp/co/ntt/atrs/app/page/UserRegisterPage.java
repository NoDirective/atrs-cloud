...
public class UserRegisterPage {
    ...
    String registPassword = "registPassword";
     ...
     */
    public UserRegisterPage setMemberInfo(MemberBean member, String imgPath) {
    ...
    /**
     * ユーザ情報登録確認を行う。
     * @return UserRegisterConfimPage ユーザ情報登録確認ページ
     */
    public UserRegisterConfimPage toRegisterConfirmPage() {
        $(".forward").click();
        // 遷移が完了したことを確認してUserRegisterConfimPageを返す。
        $(byId("content")).waitUntil(text("登録情報確認"), 2000);
